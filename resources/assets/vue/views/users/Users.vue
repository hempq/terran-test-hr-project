...
export default class Users extends Vue {
  ...
  @cStore.Action userNameToCarSearch;
  ...
  async showCars(user: User): Promise<void> {
    this.userNameToCarSearch(user.name);
