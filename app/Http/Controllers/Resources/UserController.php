...
class UserController extends Controller
{
    ...
    /**
     * Display a listing of the resource to selcet.
     *
     * @return \Illuminate\Http\Response
     */
    ...
    private function validator(Request $request, $id = null)
    {
        ...
        $request->validate([
            ...
            'status_id' => 'required|integer|between:1,2',
            'password' => 'sometimes|min:6|confirmed',
            'phone' => 'required|regex:/^[\/+][36]{2}[0-9]{9}$/'
        ], [
            'type_id.*' => __('users.invalid_user_type'),
            'phone.regex' => __('users.invalid_phone_format')
        ]);
    }
}
